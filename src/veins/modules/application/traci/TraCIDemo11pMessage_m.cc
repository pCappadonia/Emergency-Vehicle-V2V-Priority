...
int TraCIDemo11pMessage::getSenderID() const
{
    return this->senderID;
}

void TraCIDemo11pMessage::setSenderID(int senderID)
{
    this->senderID = senderID;
}

std::string TraCIDemo11pMessage::getSenderRoadID() const
{
    return this->senderRoadID;
}

void TraCIDemo11pMessage::setSenderRoadID(std::string senderRoadID)
{
